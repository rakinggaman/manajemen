    ...
    <section class="content">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title" style="margin-top:5px;"><i class="fas fa-list-ul"></i> Tipe Status</h3>
                <div class="card-tools">
                  <a href="tambah_status.php" class="btn btn-sm btn-info float-right"><i class="fas fa-plus"></i> Tambah Status</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table class="table table-bordered">
                  ...
                  //menampilkan data status
                    ...
                    $sql_h .= "order by `status` ";
                  	...
                  	<td>
                  	<a href="edit_status.php?data=<?php echo $kode_status;?>"
