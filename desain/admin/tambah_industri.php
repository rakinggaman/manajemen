  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3><i class="fas fa-plus"></i> Tambah Industri</h3>
          </div>
          <div class="col-sm-6">
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"style="margin-top:5px;"><i class="far fa-list-alt"></i> Form Tambah Industri
    </h3>
      ...
      <?php if(!empty($_GET['notif'])){?>
       ...
       <?php }?>
    	...
    	<!-- form start -->
      <form class="form-horizontal" method="post" 3.	action="konfirmasi_tambah_industri.php">
        <div class="card-body">
          <div class="form-group row">
            <label for="industri" class="col-sm-3 col-form-label">Industri</label>
            <div class="col-sm-7">
              <input type="text" class="form-control" id="industri" name= "industri" value="">
            </div>
          </div>
        </div>
        <!-- /.card-body -->
