                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        <td>1.</td>
                        <td>1231</td>
                        <td>Avisena Sanjaya</td>
                        <td>Sistem Informasi</td>
                        <td align="center">
                          <a href="edit_mahasiswa.php" class="btn btn-xs btn-info" title="Edit"><i class="fas fa-edit"></i></a>
                          <a href="#" class="btn btn-xs btn-warning"><i class="fas fa-trash" title="Hapus"></i></a>
                          <a href="detail_mahasiswa.php" class="btn btn-xs btn-info" title="Detail"><i class="fas fa-eye"></i></a>
                        </td>
                      </tr>
                      <tr>
                        <td>2.</td>
